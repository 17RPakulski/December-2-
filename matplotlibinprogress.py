...
while run:
    ...
    if sm == 's':
        ...
        if hitStandInput == 's':
            ...
            results['Strategy'].append(strategy_selection)
...
print(df)# de;ete this line later
if sm == 's':
...
#plt.bar(playerWinCount,dealerWinCount,tieCount,bothBustCount, color = 'blue')
# syntax of plt.bar ===  plt.bar(x, height, width, bottom, align)
