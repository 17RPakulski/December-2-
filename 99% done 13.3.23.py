...
def checkWin(): # issue where dealer and p1 bust but p1 won(fixed) # in maths copy in back is the outcomes
    ...
    if sm == 'm': ########################## Check this
        ...
        # check bust for dealer, player and player 2 
            ...
            if (playerTotal < 22) and (playerTotal > playerTotal2) :
                print('\nPlayer  Wins')
                return True
